...
const work  = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center text-lg mb-2 font-Ovo'>My portfolio</motion.h4>
        ...
        style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
          {workData.map((project, index) => (
            ...
            style={{backgroundImage: `url(${project.bgImage})`}}>
              ...
              <motion.div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2
              ...
              <motion.div className='border rounded-full border-black w-9 aspect-square
